...
class World(object):
    ...
    def __init__(self, carla_world, hud, sync, filter):
        """Constructor method"""
        self.sync = sync
...
class CarlaConnection:
    ...
    def init(self):
        ...
        self.world = World(client.get_world(), hud, self.sync, self.filter)
            ...
            while True:
                ...
                if self.agent is None:
                    ...
                    if self.clock_ticks == 200:
                        ...
                        self.agent = BasicAgent(self.world._player)
                ...
                self.world._player.apply_control(control_model)
